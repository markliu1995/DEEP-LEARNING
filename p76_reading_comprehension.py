...
class MySubTensors:
    def __init__(self, cfg: MyConfig):
        ...
        self.answer = tf.placeholder(tf.int64, [None, cfg.num_steps3], 'answer')
        self.inputs = [self.reading, self.question, self.answer]

        dict1 = tf.get_variable('dict1', [cfg.words, cfg.num_units], tf.float64)  # 单词向量字典
        ...
        q = tf.nn.embedding_lookup(dict1, self.question)  # [-1, steps2, units]
        question_out = []
